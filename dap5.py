...
Original file is located at
    https://colab.research.google.com/drive/1tpiD6nDAdV_9Kj5Rp8okLKfJvRY_BmPo
"""
...
dict={'name':'Ayushi','designation':'student','qual':'Btech','univ':'cmr'}
print(dict['name'])
...
dict={'name':'ayushi','designation':'Student','qual':'Btech','univ':'cmr', 'name':'ABCD'}
...
str = fo.read(10)
print ("Read String is : ", str) #ayushi---output
